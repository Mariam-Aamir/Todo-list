...
return (  
  ...
  <div className="flex flex-col items-center justify-center h-screen bg-purple-100  dark:bg-gray-900">
    ...
    <div className="w-full max-w-md bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
      ...
      <div className="flex items-center mb-4">
        <Input
          ...
          className="flex-1 mr-2 px-3 py-2 rounded-md border  border-black-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
        />
        <Button
          onClick={addTask}
